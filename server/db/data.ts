...
import { ZodiacSign, Element, Modality } from '../../shared/types.ts'
...
export const survivors: Survivor[] = [
  ...
  // S8: All-Stars (skipped; full returnee season)
  // ...
  // S20: Heroes vs. Villains
  {
    contestant: 'Sugar Kiper',
    seasons: [17, 20],
    birthday: new Date(79, 1, 22),
    gender: 'f',
    zodiacSign: ZodiacSign.Pisces,
    element: Element.Water,
    modality: Modality.Mutable,
  ...
  },
  {
    ...
    seasons: [18, 20, 27, 40],
    birthday: new Date(79, 5, 17),
    gender: 'm',
    zodiacSign: ZodiacSign.Gemini,
    element: Element.Air,
    modality: Modality.Mutable,
    placements: [8, 15, 1, 11],
    appearances: 4,
    winner: true,
  },
  {
  ...
  {
    contestant: "James 'J.T.' Thomas",
    seasons: [18, 20, 34],
    birthday: new Date(84, 5, 23),
    gender: 'm',
    zodiacSign: ZodiacSign.Cancer,
    element: Element.Water,
    modality: Modality.Cardinal,
  ...
  {
    contestant: 'Candice Cody (Woodcock)',
    seasons: [13, 20, 27],
    birthday: new Date(82, 10, 12),
    gender: 'f',
    zodiacSign: ZodiacSign.Scorpio,
    element: Element.Water,
    modality: Modality.Fixed,
